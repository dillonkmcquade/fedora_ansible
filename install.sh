...
dnf install -y -q neovim zsh neomutt newsboat protonvpn libva-intel-driver libappindicator-gtk3 gnome-tweaks gnome-shell-extension-appindicator tlp tlp-rdw mpv sxiv zathura seahorse-nautilus htop nmtui lf qbittorrent libva libva-utils libva-intel-hybrid-driver libva-intel-driver
